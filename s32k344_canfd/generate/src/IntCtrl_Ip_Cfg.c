...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration1[] = {
    {LPUART6_IRQn, (boolean)TRUE, 4U, &LPUART_UART_IP_6_IRQHandler},
    {FlexCAN0_0_IRQn, (boolean)TRUE, 4U, &CAN0_ORED_IRQHandler},
    {FlexCAN0_1_IRQn, (boolean)TRUE, 4U, &CAN0_ORED_0_31_MB_IRQHandler},
    {FlexCAN0_2_IRQn, (boolean)TRUE, 4U, &CAN0_ORED_32_63_MB_IRQHandler},
};
