...
- pin_list:
  - {pin_num: M3, peripheral: SIUL2, signal: 'gpio, 29', pin_signal: PTA29, direction: OUTPUT}
  ...
  - {pin_num: T13, peripheral: SIUL2, signal: 'gpio, 84', pin_signal: PTC20, direction: OUTPUT}
  - {pin_num: R13, peripheral: SIUL2, signal: 'gpio, 85', pin_signal: PTC21, direction: OUTPUT}
  - {pin_num: U14, peripheral: SIUL2, signal: 'gpio, 87', pin_signal: PTC23, direction: OUTPUT}
